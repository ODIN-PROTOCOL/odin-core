...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_c7e9efe3b5049e73, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c7e9efe3b5049e73, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "odin.odin.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "odin.odin.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("odin/odin/tx.proto", fileDescriptor_c7e9efe3b5049e73) }

var fileDescriptor_c7e9efe3b5049e73 = []byte{
	// 312 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xca, 0x4f, 0xc9, 0xcc,
	...
	0x32, 0x21, 0x62, 0xaa, 0xf4, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/odin.odin.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/odin.odin.Msg/UpdateParams",
	}
