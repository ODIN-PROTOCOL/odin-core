...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	cdc.RegisterConcrete(&MsgCreateNFTClass{}, "onft/CreateNFTClass", nil)
	cdc.RegisterConcrete(&MsgTransferClassOwnership{}, "onft/TransferClassOwnership", nil)
	cdc.RegisterConcrete(&MsgMintNFT{}, "onft/MintNft", nil)
}
