...
func TestDeposits(t *testing.T) {
	...
	TestAddrs := []sdk.AccAddress{testapp.TestUser1.Address, testapp.TestUser2.Address}
	...
	fourStake := sdk.NewCoins(sdk.NewCoin(govtypes.DefaultBondDenom, sdk.TokensFromConsensusPower(4)))
	fiveStake := sdk.NewCoins(sdk.NewCoin(govtypes.DefaultBondDenom, sdk.TokensFromConsensusPower(5)))
