...
//	s := rand.NewSource(1)
//	r := rand.New(s)
//	accs := []testapp.Account{testapp.Alice.Address, testapp.Bob.Address, testapp.Carol.Address}
//
//	expected := []struct {
//		weight     int
//		opMsgRoute string
...
//	initCoins := sdk.NewCoins(sdk.NewCoin(govtypes.DefaultBondDenom, initAmt))
//
