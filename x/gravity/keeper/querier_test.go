...
func TestQueryValsetConfirm(t *testing.T) {
	var (
		addrStr                       = "odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8"
		nonce                         = uint64(1)
...
func TestAllValsetConfirmsBynonce(t *testing.T) {
	input := CreateTestEnv(t)
	addrs := []string{
		"odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8",
		"odin18lxy37pqzh6d4m7auk89meg66qjl3a4sf5hx7x",
		"odin1szgz399fz9y64wk93dnahwxh7373jwpmywvms5",
	}
	var (
		nonce                       = uint64(1)
			...
			expResp: types.QueryLastPendingBatchRequestByAddrResponse{Batch: []types.OutgoingTxBatch{
				{
					...
					Transactions: []types.OutgoingTransferTx{
						{
							Id:          2,
							Sender:      "odin1qyqszqgpqyqszqgpqyqszqgpqyqszqgpkn8apk",
...
func TestQueryAllBatchConfirms(t *testing.T) {
	...
	var (
		tokenContract      = "0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B"
		validatorAddr, err = sdk.AccAddressFromBech32("odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8")
	)
	require.NoError(t, err)
		...
		Confirms: []types.MsgConfirmBatch{
			{
				...
				TokenContract: "0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B",
				EthSigner:     "0xf35e2cc8e6523d683ed44870f5b7cc785051a77d",
				Orchestrator:  "odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8",
				Signature:     "signature",
			},
		},
	}
...
func TestQueryPendingSendToEth(t *testing.T) {
	...
	var (
		now                 = time.Now().UTC()
		mySender, err1      = sdk.AccAddressFromBech32("odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8")
	...
	expectedRes := types.QueryPendingSendToEthResponse{TransfersInBatches: []types.OutgoingTransferTx{
		{
			Id:          2,
			Sender:      "odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8",
