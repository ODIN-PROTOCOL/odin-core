...
func TestDelegateKeys(t *testing.T) {
	...
	var (
		...
		valAddrs = []string{"odinvaloper17geerdwmlxpwxlahmt02vj4wy89wfstj8pacf5",
			"odinvaloper10e7tx3lsjl5yaw0sqxlaeg98ghm2k90eh4pq0n", "odinvaloper18lxy37pqzh6d4m7auk89meg66qjl3a4syfrchj",
			"odinvaloper1szgz399fz9y64wk93dnahwxh7373jwpmfnc9eq"}

		orchAddrs = []string{"odin19kypjx9c2scxfuul5mqxvum8un07scxgev4mjw", "odin1szgz399fz9y64wk93dnahwxh7373jwpmywvms5",
			"odin18lxy37pqzh6d4m7auk89meg66qjl3a4sf5hx7x", "odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8"}
	)
