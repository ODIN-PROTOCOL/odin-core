...
func SetupFiveValChain(t *testing.T) (TestInput, sdk.Context) {
	...
	SetBech32AddressPrefixesAndBip44CoinType(sdk.GetConfig())
...
func CreateTestEnv(t *testing.T) TestInput {
	...
	ibcTransferKeeper := ibctransferkeeper.NewKeeper(
		marshaler, keyIbcTransfer, getSubspace(paramsKeeper, ibctransfertypes.ModuleName), ibcKeeper.ChannelKeeper,
