...
func TestBatches(t *testing.T) {
	...
	var (
		now                    = time.Now().UTC()
		mySender, _            = sdk.AccAddressFromBech32("odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8")
...
func TestPoolTxRefund(t *testing.T) {
	...
	var (
		now                 = time.Now().UTC()
		mySender, _         = sdk.AccAddressFromBech32("odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8")
		notMySender, _      = sdk.AccAddressFromBech32("odin18lxy37pqzh6d4m7auk89meg66qjl3a4sf5hx7x")
		myReceiver          = "0xd041c41EA1bf0F006ADBb6d2c9ef9D425dE5eaD7"
		myTokenContractAddr = "0x429881672B9AE42b8EbA0E26cD9C73711b891Ca5" // Pickle
