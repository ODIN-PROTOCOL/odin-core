...
import (
	...
	v2 "github.com/ODIN-PROTOCOL/odin-core/x/gravity/migrations/v2"
...
func TestMigrateEthAddressByValidator(t *testing.T) {
	...
	validator, err := sdk.ValAddressFromBech32("odinvaloper1szgz399fz9y64wk93dnahwxh7373jwpmfnc9eq")
	assert.NoError(t, err)
...
func TestMigrateBatchConfirms(t *testing.T) {
	...
	orch, err := sdk.AccAddressFromBech32("odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8")
	assert.NoError(t, err)
	ethAddr := "0x2a24af0501a534fca004ee1bd667b783f205a546"
...
func TestMigrateStoreKeysFromKeys(t *testing.T) {
	...
	accAddr, _ := sdk.AccAddressFromBech32("odin10e7tx3lsjl5yaw0sqxlaeg98ghm2k90e6g47x8")
	valAddr, _ := sdk.ValAddressFromBech32("odinvaloper1szgz399fz9y64wk93dnahwxh7373jwpmfnc9eq")
