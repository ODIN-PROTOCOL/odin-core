...
require (
	...
	github.com/strangelove-ventures/interchaintest/v8 v8.6.0
...
replace (
	...
	github.com/stangelove-ventures/interchaintest/v8 => github.com/ODIN-PROTOCOL/interchaintest/v8 v8.6.2-odin
